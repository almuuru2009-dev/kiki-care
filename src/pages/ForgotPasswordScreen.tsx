      ...
      >
        {sent ? (
          <div className="flex flex-col items-center text-center pt-12">
            <motion.div
              className="w-20 h-20 rounded-full bg-mint-100 flex items-center justify-center mb-6"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
            ...
            <button onClick={() => { setSent(false); setEmail(''); }} className="btn-ghost w-full text-sm mt-2">
              Reenviar email
            </button>
          </div>
        ) : (
